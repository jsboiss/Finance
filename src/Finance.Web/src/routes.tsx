...
export const router = createRouter({ routeTree: rootRoute.addChildren([indexRoute, accountsRoute, transactionsRoute, payBreakdownsRoute, subscriptionsRoute, importsRoute, settingsRoute]) })
